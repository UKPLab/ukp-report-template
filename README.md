...
[![License](https://img.shields.io/github/license/UKPLab/ukp-report-template)](https://opensource.org/licenses/Apache-2.0)
[![Python Versions](https://img.shields.io/badge/Python-3.9-blue.svg?style=flat&logo=python&logoColor=white)](https://www.python.org/)
[![CI](https://github.com/UKPLab/ukp-report-template/actions/workflows/main.yml/badge.svg)](https://github.com/UKPLab/ukp-report-template/actions/workflows/main.yml)
...
To import classes/methods of `ukp_report_template` from inside the package itself you can use relative imports: 
...
```py
from ukp_report_template import BaseClass # Notice how I omit the file name
from ukp_report_template.subpackage import SubPackageClass # Here it's necessary because it's a subpackage
...
This is how you can use `ukp_report_template` from command line:

```bash
$ python -m ukp_report_template
```
