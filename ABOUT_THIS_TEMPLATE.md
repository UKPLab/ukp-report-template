...
- 🎯 Entry points to execute your program using `python -m <ukp_report_template>` with basic CLI argument parsing.
- 🔄 Continuous integration using [Github Actions](https://github.com/UKPLab/ukp-report-template/actions) with jobs to check, lint and test your project.
...
│
├───ukp_report_template             # The main python package for the project
...
You should create new files and subpackages inside ukp_report_template and implement your functionalities there. Remember to add what you write to `__init__.py` so that the imports work smoothly. Take a look at `base.py` and `__init__.py` to understand how it works.
...
It contains [GitHub Actions](https://docs.github.com/en/actions) that are executed automatically when pushing your code. You can see results for your repository [here](https://github.com/UKPLab/ukp-report-template/actions).
